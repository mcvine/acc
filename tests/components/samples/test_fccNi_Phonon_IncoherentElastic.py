...
def test_cpu():
    instr = os.path.join(thisdir, "fccNi_PhononIncohEl_plate_instrument.py")
    outdir = 'out.fccNi_PhononIncohEl_plate'
...
def main():
    ...
    test_compare_mcvine(num_neutrons=int(1e3), interactive=True)
    return
